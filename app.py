...
st.set_page_config(
    ...
    menu_items={
        'Get Help': 'https://www.linkedin.com/in/andreean-dharma-arisandi/',
        'Report a bug': "https://www.google.com",
        'About': "### Final Project Full-Time Data Science Hacktiv8 By Andreean Dharma Arisandi"
    }
)
...
st.subheader('Makankuy! adalah sebuah aplikasi pemesanan tempat makan terdekat wilayah Jakarta, yang dapat memberikan rekomendasi berdasarkan suasana yang diinginkan oleh customer serta preferensi tempat makan yang telah diketahui customer.')
st.write('-----')
...
elif opsi == 'Rekomendasi Berdasarkan Keinginan':
